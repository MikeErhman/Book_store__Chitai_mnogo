...
var about_book_div_desk = document.getElementById("quotes_div-desk")
...
var buttons = [about_book, quotes, notes, about_book_desk, quotes_desk, notes_desk]
	...
	button.addEventListener('click', function(){
		...
		switch(true){
			case button.id == "about_book-id" || "about_book-id-desk" : if(naw_square.className != "naw_sqre-left" && naw_square_desk.className != "naw_sqre-left") {
				...
				break
			case button.id == "quotes-id" || "quotes-id-desk" : if(naw_square.className != "naw_sqre-center" && naw_square_desk.className != "naw_sqre-center"){
				toggle_divs(button); 
				naw_square.className = "naw_sqre-center"
				naw_square_desk.className = "naw_sqre-center"
			};
				break
			case button.id == "notes-id" || "notes-id-desk" : if(naw_square.className != "naw_sqre-right" && naw_square_desk.className != "naw_sqre-right"){
				toggle_divs(button);
